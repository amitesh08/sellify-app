    ...
    return (
        ...
        >
            ...
            <Box p={4}>
                ...
                <HStack spacing={2} >
                    <IconButton icon={<FaRegEdit />} onClick={() => onOpen(product.id)} colorScheme="blue" />
                    <IconButton icon={<MdDelete />} onClick={() => handleDeleteProduct(product.id)} colorScheme="red" />
                </HStack>
            ...
            <Modal isOpen={isOpen} onClose={onClose}>
                ...
                <ModalContent>
                    ...
                    <ModalFooter>
                        <Button colorScheme="blue" mr={3} onClick={()=> handleUpdateProduct(product.id, updatedProduct)}>
                            Update
                        </Button>
